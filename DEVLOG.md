...
- **E2E (Playwright/Chromium, mock 모드)**: `npm test` → **28/28 통과, 콘솔 에러 0**
  - 렌더 / KPI 집계(7) / 통계 / 환자 검색·이동 / 예약 관리(상태변경·추가·삭제) / 새로고침 / 신규 진료 시작 / 입원·병동·등록·퇴원 / 환자 전환 / 탭4 / 테마 / 대기열 검색·정렬 / 노트·처방·척도·검사 CRUD
